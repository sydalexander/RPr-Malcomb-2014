...
Although we were able to reproduce the figures from the original study in a new computational environment, we were unable to perfecly reproduce its results. 
We were also able to implement unplanned deviations that we felt would improve the study, including different visualization choices.
...
Furthermore, there were several subjective decisions made throughout Malcomb's study which were not elaborated upon, such as the decisions made to create weights based on the results from the interviews.
