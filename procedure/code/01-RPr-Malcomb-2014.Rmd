...
The purpose of this study was to reproduce Malcomb's Vulnerability Modeling Study in Malawi, and to test how effectively we were able to do so.
...
and compared our scores to the values calculated in the original study. 

As noted above, the reproduction study used the indicators and weights as they were described in the original study.
One of the bigger issues with Malcomb's choice to black box the interview process and the way by which he created weights for his different variables. Those interested in reproducing the study would have a harder time of making different decisions about the way they weight different variables, given that Malcomb's methods and reasoning for his weighting is unavailable. 
...
Regarding its significance within the greater context of reproducibility for GIS science, our reproduction of Malcomb's study was successful in that we were able to reproduce the figures from the original study in a new computational environment.
...
However, our reproduction was imperfect for several reasons.
